...
import { Clock, CheckCircle2, ClipboardList, Eye } from "lucide-react";
...
export default function ParentAssessmentsTab({ studentId, studentClassId: passedClassId }: Props) {
  const [resolvedClassId, setResolvedClassId] = useState<string | null>(passedClassId || null);
  ...
  const fetchData = async () => {
    ...
    let classId = passedClassId || null;
    ...
    if (!classId) {
      ...
      classId = classLink?.class_id || null;
